...
public:
	...
	VOID Init(PROCESSOR_INFO& procInfo, CoreTypes coreType, int thread_count = MAX_THREADS);
...
private:
	static DWORD WINAPI ThreadMain(VOID* scheduler);
    ...
    VOID ExecuteTasks();
      ...
      // Number of worker threads that have been created
    INT             miThreadCount;
      // Per thread data
    HANDLE*         mpThreadData;
