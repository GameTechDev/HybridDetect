...
static __itt_string_handle* gRenderSubset = __itt_string_handle_create("RenderSubsetTask");
static __itt_string_handle* gUpdate = __itt_string_handle_create("Update");
static __itt_string_handle* gSimUpdate = __itt_string_handle_create("UpdateSubsetTask");
...
void ProfileBeginUpdate() { __itt_task_begin(gDomain, __itt_null, __itt_null, gUpdate); }
void ProfileEndUpdate() { __itt_task_end(gDomain); }
